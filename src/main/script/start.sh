...
export PATH="/usr/local/ant/apache-ant-1.10.12/bin:$PATH"
...
JAVA_OPTS="-Dfile.encoding=UTF-8 -Dcontract.server.home=$SERVER_HOME -server -Xms128m -Xmx512m "

MAIN_CLASS=io.nuls.ContractValidationServerBootstrap
